...
export const metadata = {
  ...
  description:
    "The terms and conditions governing your use of the SupplySync platform.",
};
      ...
      <section className="border-b border-border/40 bg-gradient-to-br from-primary/5 via-background to-background py-20">
        <div className="container max-w-2xl mx-auto text-center px-4 space-y-5">
          ...
          <p className="text-muted-foreground">
            Effective date:{" "}
            <span className="font-medium text-foreground">January 1, 2025</span>
          </p>
          <p className="text-muted-foreground leading-relaxed">
            Please read these Terms carefully before using the SupplySync
            platform. They govern your relationship with us.
          </p>
        </div>
      </section>
