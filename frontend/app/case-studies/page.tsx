...
export const metadata = {
  ...
  description:
    "See how leading enterprises use SupplySync to transform their supply chain operations.",
};
...
const cases = [
  {
    ...
    summary:
      "Reduced order allocation time by 78% and cut delivery costs by $2.4M annually by switching to SupplySync's AI-powered routing engine.",
    metrics: [
  ...
  },
  {
    ...
    summary:
      "Achieved full cold-chain compliance and real-time visibility across 12 distribution centres, eliminating $900K in spoilage losses.",
    metrics: [
  ...
  },
  {
    ...
    industry: "Automotive",
    summary:
      "Scaled supplier network from 40 to 200+ vendors in 6 months with zero disruption, processing 3× more orders on the same team headcount.",
    metrics: [
      ...
      <section className="relative border-b border-border/40 bg-gradient-to-br from-primary/5 via-background to-background py-24">
        ...
        <div className="container text-center max-w-3xl mx-auto px-4 space-y-6">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            Discover how SupplySync customers are cutting costs, boosting
            efficiency, and scaling operations faster than ever.
          </p>
        </div>
      </section>
      ...
      <section className="border-t border-border/40 bg-muted/30 py-16">
        <div className="container text-center max-w-xl mx-auto px-4 space-y-5">
          ...
          <p className="text-muted-foreground">
            Talk to our team and get a personalised demo tailored to your
            industry.
          </p>
          <Link
            href="/contact"
