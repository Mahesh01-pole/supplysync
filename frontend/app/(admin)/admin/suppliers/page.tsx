...
export default function AdminSuppliersPage() {
  usePageTitle("Suppliers", "SupplySync Admin");
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-500 mt-1">
            All {suppliers.length} registered suppliers on the platform.
          </p>
        </div>
        <button
          onClick={load}
              ...
              >
                <div className="flex justify-between items-start mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="font-semibold text-slate-900 group-hover:text-purple-700 transition-colors text-sm leading-tight">
                        {s.company_name}
                      </h3>
                    </div>
                  </div>
                  <span
                    className={`inline-flex items-center gap-1 px-2 py-1 rounded-md text-[10px] font-bold uppercase tracking-wider ${s.active ? "bg-emerald-100 text-emerald-700" : "bg-slate-100 text-slate-500"}`}
                  >
                    {s.active ? (
                ...
                <div className="grid grid-cols-2 gap-3 pt-4 border-t border-slate-100">
                  ...
                  <div>
                    ...
                    <p className="text-lg font-bold text-slate-800">
                      {s.avg_fulfillment_time_minutes}m
                    </p>
                  </div>
                </div>
              </div>
