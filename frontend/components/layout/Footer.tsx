...
export function Footer() {
  return (
    <footer className="w-full border-t border-border/40 bg-zinc-50/50 mt-auto transition-colors duration-200">
        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-4 md:gap-8">
          <div className="space-y-6 md:col-span-1">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Intelligent B2B supply chain solutions with real-time order
              allocation, optimized delivery routing, and predictive analytics.
            </p>
            <div className="flex gap-4 pt-2">
              <Link
                href="#"
                className="h-10 w-10 flex items-center justify-center rounded-full bg-muted/50 text-muted-foreground hover:bg-primary/10 hover:text-primary transition-all duration-200"
              >
